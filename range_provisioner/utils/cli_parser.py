...
def parser():
    ...
    provision_args.add_argument("-p", "--pipeline", action="store_true", help="Use Pipeline vars defined in globals.yaml")
    provision_args.add_argument("-d", "--default", action="store_true", help="Use Default CLI Inputs")
